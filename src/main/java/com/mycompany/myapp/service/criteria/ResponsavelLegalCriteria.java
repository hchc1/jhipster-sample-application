...
/**
 * Criteria class for the {@link com.mycompany.myapp.domain.ResponsavelLegal} entity. This class is used
 * in {@link com.mycompany.myapp.web.rest.ResponsavelLegalResource} to receive all the possible filtering options from
...
public class ResponsavelLegalCriteria implements Serializable, Criteria {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, nome, cpf, distinct);
    }
